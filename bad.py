...
NOT EVERY PROMPT REQUIRES A CODE RESPONSE. IN ADDITION, IN THIS VERSION OF PYTHON, THERE IS A FUNCTION get_object_coords().
IT TAKES A STRING AS AN ARGUMENT AND RETURNS THE PYAUTOGUI COORDS AS A TUPLE OF INTEGERS. THE STRING IS THE TEXT REPRESENTING WHAT OBJECT YOU WANT TO FIND (eg. Google Chrome App Icon in order to get the coordinates for Google Chrome).
